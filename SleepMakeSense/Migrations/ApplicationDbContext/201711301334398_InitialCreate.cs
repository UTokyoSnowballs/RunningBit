    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AspNetUsers1", t => t.AspNetUserId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Userdatas", "AspNetUserId", "dbo.AspNetUsers1");
            DropForeignKey("dbo.UserQuestions", "AspNetUserId", "dbo.AspNetUsers1");
            DropForeignKey("dbo.TokenManagements", "AspNetUserId", "dbo.AspNetUsers1");
            DropForeignKey("dbo.FitbitDatas", "AspNetUserId", "dbo.AspNetUsers1");
            DropForeignKey("dbo.DiaryDatas", "AspNetUserId", "dbo.AspNetUsers1");
