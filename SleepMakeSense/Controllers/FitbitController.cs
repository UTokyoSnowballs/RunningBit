...
namespace SleepMakeSense.Controllers
{
    public class FitbitController : Controller
    {
        ...
        public ActionResult Authorize()
        {
            ...
            string[] scopes = new string[] { "profile", "activity", "sleep", "weight", "nutrition", "location", "heartrate" };
        ...
        public async Task<ActionResult> Callback()
        {
            ...
            //return RedirectToAction("Index", "Home");
            return RedirectToAction("Index", "ActivityLogsLists"); // redirect to UserdatasController.cs/Sync().
