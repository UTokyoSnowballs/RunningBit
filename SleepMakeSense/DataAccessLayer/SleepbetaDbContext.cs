...
namespace SleepMakeSense.DataAccessLayer
{
    public class SleepbetaDataContext : DbContext
    {
        ...
        public System.Data.Entity.DbSet<SleepMakeSense.Models.RunningRoute> RunningRoutes { get; set; }

        public System.Data.Entity.DbSet<SleepMakeSense.Models.AspNetUser> AspNetUsers { get; set; }
